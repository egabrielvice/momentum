...
def save_workout_session(session_date, day, workout_name, started_at, ended_at, duration_seconds, status="completed", notes=""):
    duration_seconds = int(duration_seconds or 0)
    duration_minutes = round(duration_seconds / 60, 2)
    execute("""
        INSERT INTO workout_sessions
        (session_date, day, workout_name, started_at, ended_at, duration_seconds, duration_minutes, status, notes)
        VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
    """, (
        session_date,
        day,
...
def get_workout_sessions(limit=25):
    return fetch_df("""
        SELECT id, session_date, day, workout_name, started_at, ended_at, duration_seconds, duration_minutes, status, notes
