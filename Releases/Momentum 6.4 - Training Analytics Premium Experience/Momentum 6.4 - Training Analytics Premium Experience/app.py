...
st.set_page_config(page_title="Momentum 6.4", page_icon="🏋️", layout="wide", initial_sidebar_state="collapsed")
init_db()
...
if page == "Dashboard":
    ...
    st.code("Momentum 6.4 - Training Analytics + Premium Experience")
