...
st.set_page_config(page_title="Momentum 5.0", page_icon="🏋️", layout="wide", initial_sidebar_state="collapsed")
init_db()
...
page = st.sidebar.radio("Navigation", ["Dashboard", "Today's Workout", "Progress Hub", "Analytics", "Workout Log", "Exercise History", "Bodyweight Log", "Program Manager", "Program Editor", "Export / Backup", "Settings"])
...
if page == "Dashboard":
    ...
    st.caption("A focused view of your bodyweight, records, consistency, and phase progress.")
    ...
    st.subheader("Momentum Score Breakdown")
    for item in score_details:
        st.write(f"• {item}")

elif page == "Analytics":
    st.header("Analytics")
    st.caption("Training patterns, program count, and exercise frequency.")
    ...
    st.subheader("Muscle Group Log Summary")
    ...
    st.code("Momentum 5.0 - Premium Operating System")
